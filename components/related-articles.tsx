...
export default function RelatedArticles({ relatedPosts }: RelatedArticlesProps) {
  console.log('RelatedArticles component - relatedPosts:', relatedPosts);
  console.log('RelatedArticles component - relatedPosts.length:', relatedPosts.length);
  
  if (relatedPosts.length === 0) {
    console.log('RelatedArticles: No related posts found, returning null');
    return null;
  }
