    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-escape-red to-escape-red-700 bg-clip-text text-transparent">
            How It Works?
          </h2>
            ...
            <div key={index} className="text-center group relative">
              ...
              <div className="relative p-6">
                <div className="relative mb-8">
                  <div
                    className={`inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br ${step.color} rounded-full shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 relative z-10`}
                  >
                    <step.icon className="h-12 w-12 text-white" />
                  </div>
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-escape-red rounded-full shadow-md flex items-center justify-center text-sm font-bold text-white z-20">
                    {index + 1}
                  </div>
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-12 left-full w-full h-0.5 bg-gradient-to-r from-escape-red/30 to-transparent z-0" />
                  )}
                </div>
                <h3 className="text-2xl font-bold mb-4 text-foreground group-hover:text-escape-red transition-colors duration-300">{step.title}</h3>
